...
Usage:
    python scripts/figures/grid.py
Writes:
    figures/grid.pdf (vector)
    figures/grid.png (300 DPI raster, map figures use PNG per the plan's
...
pdf_path = os.path.join(OUT_DIR, 'grid.pdf')
png_path = os.path.join(OUT_DIR, 'grid.png')
